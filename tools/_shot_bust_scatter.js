/* Screenshot state: dice mid-scatter + the shield ring live. SUITE: exclude */
...
await sleep(700);
_bustImpact();
_bustShieldFX('#ffd98a');
await sleep(650);/* mid-scatter, ring at peak - the capture renders it */
return {ok:true};
