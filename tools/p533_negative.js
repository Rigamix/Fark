/* P533 arm: negative - ONE arm per browser session (the S6 lesson).
...
const a=G.pool[0],b=G.pool[1];a.ench={t:'tithe',face:1};a.val=1;b.ench=null;b.val=3;const dice=[a,b];
...
return {arm:'negative', pts:pts, icons:sp.icons.length, predicateAccepts:accepted,
        expectedAccept:false, rollButtonLit:lit, diceCommitted:committedNow,
        buttonMatchesPress:(lit===true)===committedNow,
        ok:(accepted===false)&&(lit===false)&&(committedNow===false)};
