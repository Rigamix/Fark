/* Screenshot state: win screen with the middle offer card FOCUSED. SUITE: exclude */
...
await sleep(3000);
tap([...document.querySelectorAll('#end-ov .fo-offer .fcv')][1]);
await sleep(1400);
const t=document.getElementById('cardFocusTip');
const b=t?t.getBoundingClientRect():null;
return {tip:!!t,tipT:b?+(100*b.top/innerHeight).toFixed(1):null,
  tipB:b?+(100*b.bottom/innerHeight).toFixed(1):null};
