/* P533 arm: scorer - ONE arm per browser session (the S6 lesson).
...
const a=G.pool[0];a.ench=null;a.val=1;const dice=[a];
...
return {arm:'scorer', pts:pts, icons:sp.icons.length, predicateAccepts:accepted,
