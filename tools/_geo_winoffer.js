/* Win-offer geometry: the boxes that matter, as % of viewport height. SUITE: exclude */
...
return {vh:innerHeight,
 panel:box('#end-ov .win-panel'),board:box('#end-ov .win-board'),
 title:box('#end-ov .fo-title'),offer:box('#end-ov .fo-offer'),
 card0:box('#end-ov .fo-card'),deck:box('#end-ov .fo-deck'),
 slot0:box('#end-ov .fo-slot'),skip:box('#end-ov>.fo-skip')};
